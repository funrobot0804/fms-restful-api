...
payload = { "start_time":float( time.time() ),    # 格式為float，西元1970年後所經過的浮點秒數(UTC)         
            ...
            #
            #
            # ["DockTo_Leave", [toward direction(字串), distance(float)]]
            #
            #  toward direction => "Front" (AMR向前走以離開充電站)
            #                      "Back" (AMR向後走以離開充電站)
            #
            #  distance => 離開的距離
            # 
            ...
            # ["DockTo_Leave"]
            # 
            #  Use default toward direction: "Front" and use default distance by AMR itself
            #
            #
            #
            #
            "task_arr":[       
                         ["DockTo_Leave", ["Front", 0.5]],
                         ["DockTo_Leave"]
                       ] 
