...
payload = { "start_time":float( time.time() ),    # 格式為float，西元1970年後所經過的浮點秒數(UTC)         
            ...
            # MoveTo_TrafficRailSingle指令格式
            #
            # 指定前往目的地，可使用'座標點'或是'目的地名稱'
            #

            "task_arr":[ ["MoveTo_AlongRailSingle",["origin","sharp_city@1F","track_1"]],
                         ["MoveTo_AlongRailSingle",["origin","sharp_city@1F","track_1"],"Path"],
                         ["MoveTo_AlongRailSingle",["origin","sharp_city@1F","track_1"],"Rail"]
                       ] 
