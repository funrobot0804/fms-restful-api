...
# 根據交通管理設定，有時候派遣系統會自動計算產生軌跡，透過此API，可將'所有'的軌跡抓出來

url = "http://127.0.0.1:6600"+"/get_rail_traffic"
payload = {
...
try:
    ...
    回傳資料格式
    {
        ...
        'value':{'rail':         
                 [
                    [["T1",[-4.74,6.48],[-10.66,21.06],507,"1F"],
                     ["T2",[-22.22,20.42],[-19.58,28.58],666,"1F"]
                    ] 
                 ] 
                }
        }        
    ...
    print("len(rail_list)=", len(rail_list))
